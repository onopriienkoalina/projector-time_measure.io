...
calculateBtn.addEventListener('click', () => {
  ...
  let timeResult;
/*if (getPresets === 'week') {
  timeResult = (getEndDAte.getTime() - getStartDate.getTime()) / (1000 * 60 * 60 * 24 *7);
} else if (getPresets === 'month') {
  timeResult = (getEndDAte.getMonth() - getStartDate.getMonth()) + (12 * (getEndDAte.getFullYear() - getStartDate.getFullYear()));
} else {
  timeResult = (getEndDAte.getTime() - getStartDate.getTime()) / (1000 * 60 * 60 * 24);
}*/
